...
namespace Glueful\Extensions\ImportExport\Tests\Integration\Schema;
...
final class SchemaVerifierBehaviorTest extends TestCase
{
    ...
    private ImportExportSchemaVerifier $verifier;
    private string $dbPath;

    protected function setUp(): void
    {
        $this->dbPath = sys_get_temp_dir() . '/import-export-verify-' . uniqid('', true) . '.sqlite';
        ...
        $this->verifier = new ImportExportSchemaVerifier();
    }
