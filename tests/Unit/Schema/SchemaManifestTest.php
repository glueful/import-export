...
namespace Glueful\Extensions\ImportExport\Tests\Unit\Schema;

use Glueful\Extensions\ImportExport\Schema\ImportExportSchemaVerifier;
...
final class SchemaManifestTest extends TestCase
{
    ...
    public function testVerifierClassConformsToTheManifestContract(): void
    {
        ...
        self::assertSame('glueful/import-export', (new $class())->source());
    }

    public function testVerifierCoversEveryRecursivelyDiscoveredMigration(): void
    {
        $mapped = (new ImportExportSchemaVerifier())->migrationBasenames();
    ...
    {
        $g = $this->manifest();
        $candidates = ['glueful/import-export' => new \Glueful\Extensions\ExtensionCandidate(
            name: 'glueful/import-export',
            provider: $g['provider'],
        ...
        self::assertSame([], $result->errors, 'import-export must resolve enabled-alone');
    }
